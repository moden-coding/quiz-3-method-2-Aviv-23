...
public class App {
    ...
    public static int computePerimeter(String mode, int height, int width) {
        if (height < 0 || width < 0 || height >= 100 || width >= 100) {
            return -1;
            // I return -1 twice because the firswt ime I do it it eleminiates any invalid
            // inputs for height and width
            // the second time it removes invalid mode inputs. I wrote the code like this
            // because I dodnt want to make my
            // if statements for rect and square super big by adding in parameters for valid
            // inputs for each
